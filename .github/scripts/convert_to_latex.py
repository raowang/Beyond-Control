...
files = [
    ...
    ('第十六章-技能经济学的重构.md', 'latex/chapter16.tex'),
    ('第十七章-T型能力的进化.md', 'latex/chapter17.tex'),
    ('第十八章-判断力.md', 'latex/chapter18.tex'),
    ('第十九章-人机协作技能.md', 'latex/chapter19.tex'),
    ('第二十章-关系技能.md', 'latex/chapter20.tex'),
    ('PART-VI-阻力维度.md', 'latex/part-vi.tex'),
    ('第二十一章-最强大的变革阻力来自群体.md', 'latex/chapter21.tex'),
    ('第二十二章-三类既得利益者的转型困境.md', 'latex/chapter22.tex'),
    ('第二十三章-变革联盟与软着陆路径.md', 'latex/chapter23.tex'),
    ('PART-VII-面向未来.md', 'latex/part-vii.tex'),
    ('第二十四章-如果德鲁克今天写动荡时代的管理.md', 'latex/chapter24.tex'),
    ('第二十五章-管理者的下一步.md', 'latex/chapter25.tex'),
    ('第二十六章-结语.md', 'latex/chapter26.tex'),
]
